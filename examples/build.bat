...
-fno-builtin -ffreestanding -fno-asynchronous-unwind-tables -fuse-ld=lld -fsanitize=undefined -fsanitize-trap ^
-Wall -Wextra -Werror -Wvla -Wconversion -Wdouble-promotion -Wno-sign-conversion -Wno-missing-field-initializers -Wuninitialized -Winit-self -Wunused -Wunused-macros -Wunused-local-typedefs

set DEF_FLAGS_LINKER=-lkernel32

set SOURCE_NAME=dyn_array_win32_nostdlib
